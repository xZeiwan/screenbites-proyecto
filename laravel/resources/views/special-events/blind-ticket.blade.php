...
<head>
    ...
    <title>Screenbites - Blind Ticket Event</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        nav a:hover, nav .logout-btn:hover { color: var(--color-principal) !important; transform: scale(1.05); }
        ...
        .nav-cart:hover { color: var(--color-principal); transform: scale(1.1); }
        ...
        .backdrop-img {
            ...
            /* Imagen oscura genérica para el misterio */
        ...
        .mystery-poster .glitch-mark {
            font-size: 180px; color: var(--color-principal); font-family: 'Arial Black', sans-serif;
            text-shadow: 2px 2px 0px #ff0000, -2px -2px 0px #0000ff;
            animation: glitch 1.5s infinite;
        }

        @keyframes glitch {
            0% { transform: translate(0); text-shadow: 2px 2px 0px #ff0000, -2px -2px 0px #0000ff; }
            20% { transform: translate(-2px, 2px); text-shadow: -2px -2px 0px #ff0000, 2px 2px 0px #0000ff; }
            40% { transform: translate(-2px, -2px); text-shadow: 2px -2px 0px #ff0000, -2px 2px 0px #0000ff; }
            60% { transform: translate(2px, 2px); text-shadow: -2px 2px 0px #ff0000, 2px -2px 0px #0000ff; }
            80% { transform: translate(2px, -2px); text-shadow: 2px 2px 0px #ff0000, -2px -2px 0px #0000ff; }
            100% { transform: translate(0); text-shadow: 2px 2px 0px #ff0000, -2px -2px 0px #0000ff; }
        }

        .movie-info { flex: 1; }
        .movie-id { color: var(--color-principal); font-size: 14px; letter-spacing: 5px; margin-bottom: 10px; display: inline-block; background: rgba(255,208,0,0.1); padding: 5px 10px; border-radius: 4px; }
        ...
        .btn-buy:hover { background: var(--color-blanco); color: var(--color-negro); transform: translateY(-3px); box-shadow: 0 15px 25px rgba(255, 208, 0, 0.4); }
        .btn-buy:hover img { filter: invert(1); }
        ...
        .mechanic-icon { width: 60px; height: 60px; background: rgba(255,208,0,0.1); color: var(--color-principal); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 24px; }
        ...
        /* THE RULES BOX */
        .rules-box { border: 2px solid var(--color-principal); border-radius: 12px; padding: 40px; background: rgba(255,208,0,0.02); display: flex; gap: 40px; align-items: center; }
        ...
        .footer-col h4 { font-size: 16px; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 20px; color: var(--color-principal); }
        ...
        .footer-links a:hover { color: var(--color-principal); }
        ...
        .footer-credits span { color: var(--color-principal); font-weight: bold; }
    ...
    <div class="movie-hero">
        ...
        <div class="movie-content">
            ...
            <div class="movie-info">
                <span class="movie-id">SPECIAL EVENT</span>
                <h1 class="movie-title">Blind Ticket: 80s Sci-Fi</h1>

                <div class="movie-meta">
                    <span class="age-badge">+18</span>
                    <span>Sci-Fi / Mystery</span>
                    <span>Approx. 2h 00m</span>
                    <span style="color: var(--color-principal); font-weight: bold;">November 12 • 23:00</span>
                </div>

                <p class="movie-desc">Step into the unknown. We've selected a cult classic masterpiece from the 1980s that redefined the sci-fi genre. You won't know the title, the director, or the actors until the lights go completely dark. Do you trust our curation?</p>
        ...
        <div class="container">
            ...
            <div class="mechanics-grid">
                <div class="mechanic-card">
                    ...
                    <h3>1. Book the Secret</h3>
                    <p>Purchase your blind ticket at a highly discounted price. You select your seat, but the movie remains classified.</p>
                </div>
                <div class="mechanic-card">
                    <div class="mechanic-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
                    </div>
                    <h3>2. No Spoilers</h3>
                    <p>Arrive at the cinema. There will be no posters, no trailers, and our staff is sworn to absolute secrecy.</p>
                </div>
                <div class="mechanic-card">
                    <div class="mechanic-icon">
                    ...
                    <h3>3. The Reveal</h3>
                    <p>Grab your popcorn, take your seat, and wait for the lights to dim. The movie is revealed as the opening scene starts.</p>
                </div>
            </div>

            <div class="clues-wrapper">
                <div class="clues-header">
                    <h3>Decipher the Clues</h3>
                    <p style="color: #aaa; font-family: Arial, sans-serif;">Can you guess the movie before the lights go out? Here is what we can tell you:</p>
                </div>
                <div class="clues-list">
                    <div class="clue-item">"The soundtrack is heavily dominated by synthesizers, creating an unforgettable atmosphere."</div>
                    <div class="clue-item">"It was originally released between 1982 and 1984 and received mixed reviews before becoming a cult classic."</div>
                    <div class="clue-item">"Neon lights, eternal rain, and philosophical questions about what makes us human."</div>
                    <div class="clue-item">"Directed by a filmmaker who had recently revolutionized the horror/sci-fi genre just a few years prior."</div>
                </div>
            </div>
            ...
            <div class="rules-box">
                ...
                <div class="rules-content">
                    <h3>The Rules of the Blind Screening</h3>
                    <ul>
                        <li><strong>Strictly +18:</strong> Due to the unknown nature of the film, IDs will be checked at the door.</li>
                        <li><strong>No Refunds:</strong> You are paying for the experience. If you've already seen the movie or don't like it, refunds are not permitted.</li>
                        <li><strong>Zero Phones:</strong> To preserve the mystery for latecomers, using phones to record the title sequence will result in immediate removal.</li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        function addBlindTicketToCart() {
            ...
            let blindOrder = {
                ...
                color: '#ffd000',
                textColor: 'black',
                // Le asignamos un asiento al azar temporal (en un futuro podríais dejar que el usuario lo elija)
