...
<head>
    ...
    <title>Screenbites - Tarantino Q&A</title>
    ...
    <style>
        :root {
            ...
            --color-blanco: #ffffff;
            --color-principal: #ffd000; /* Dorado Tarantino */
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .backdrop-img {
            ...
            background-image: url('https://images.unsplash.com/photo-1485846234645-a62644f84728?q=80&w=1920');
...
<body>
    ...
    <div class="movie-hero">
        ...
        <div class="movie-content">
            ...
            <div class="movie-info">
                <span class="movie-id">EXCLUSIVE Q&A</span>
                <h1 class="movie-title">Director's Q&A: Tarantino</h1>

                <div class="movie-meta">
                    <span class="age-badge">+18</span>
                    <span>Screening & Talk</span>
                    <span>Approx. 3h 30m</span>
                    <span style="color: var(--color-principal); font-weight: bold;">November 18 • 19:30</span>
                </div>

                <p class="movie-desc">Una experiencia única. Disfruta de la proyección en 4K de Pulp Fiction, seguida inmediatamente por una charla en vivo y en directo con el mismísimo Quentin Tarantino respondiendo las preguntas del público.</p>

                <div class="action-buttons">
                    <span class="price-tag-big">$15.00</span>

                    @auth
                        @php
                            // Lógica de fecha: El evento se abre el 18 de Nov de 2026
        ...
        <div class="container">
            ...
            <div class="mechanics-grid">
                <div class="mechanic-card">
                    ...
                    <h3>1. Remastered Viewing</h3>
                    <p>Disfruta de la película en una restauración 4K exclusiva aprobada por el propio director.</p>
                </div>
                <div class="mechanic-card">
                    <div class="mechanic-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg>
                    </div>
                    <h3>2. Live Dialogue</h3>
                    <p>45 minutos de charla en profundidad explorando los secretos y anécdotas del rodaje.</p>
                </div>
                <div class="mechanic-card">
                    <div class="mechanic-icon">
                    ...
                    <h3>3. Your Turn</h3>
                    <p>Envía tu pregunta a través de nuestra web al comprar tu entrada; se elegirán las 5 mejores.</p>
                </div>
            </div>

            <div class="clues-wrapper">
                <div class="clues-header">
                    <h3>Exclusive Details</h3>
                    <p style="color: #aaa; font-family: Arial, sans-serif;">Here is what we can tell you about the Q&A session:</p>
                </div>
                <div class="clues-list">
                    <div class="clue-item">"The session will include a never-before-seen deleted scene from the original cut."</div>
                    <div class="clue-item">"All attendees will receive a commemorative physical ticket and a VIP lanyard."</div>
                    <div class="clue-item">"Professional photography is allowed only during the first 5 minutes of the talk."</div>
                    <div class="clue-item">"The Director will sign a maximum of 10 items randomly selected among the audience."</div>
                </div>
            </div>
            ...
            <div class="rules-box">
                ...
                <div class="rules-content">
                    <h3>The Rules of the Q&A</h3>
                    <ul>
                        <li><strong>Respect the Mic:</strong> Por favor, guarda silencio absoluto durante la charla.</li>
                        <li><strong>No Flash:</strong> No se permite el uso de flash fotográfico en ningún momento de la proyección ni de la charla.</li>
                        <li><strong>Punctuality:</strong> Las puertas se cerrarán 5 minutos antes del inicio. No se admitirán rezagados bajo ningún concepto.</li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        function addEventTicketToCart() {
            ...
            let eventOrder = {
                id: 'ORD-QNA-' + Date.now(),
                movieId: 'tarantino-01',
                movieTitle: "Director's Q&A: Tarantino",
                color: '#ffd000',
                textColor: 'black',
                tickets: { seats: 'VIP Seat', price: 15.00 },
                food: [],
                orderTotal: 15.00
            };
