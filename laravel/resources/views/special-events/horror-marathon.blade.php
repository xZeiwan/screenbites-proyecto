...
<head>
    ...
    <title>Screenbites - Horror Marathon</title>
    ...
    <style>
        :root {
            ...
            --color-blanco: #ffffff;
            --color-principal: #ff4444; /* Rojo Terror */
            --color-texto-btn: white;
        }
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .backdrop-img {
            ...
            background-image: url('https://images.unsplash.com/photo-1505635330303-d3f8462c8a01?q=80&w=1920');
        ...
        .mystery-poster::before {
            ...
            background: linear-gradient(to right, transparent, rgba(255,68,68,0.1), transparent);
        ...
        .movie-info { flex: 1; }
        .movie-id { color: var(--color-principal); font-size: 14px; letter-spacing: 5px; margin-bottom: 10px; display: inline-block; background: rgba(255,68,68,0.1); padding: 5px 10px; border-radius: 4px; }
        ...
        .btn-buy:hover { background: var(--color-blanco); color: var(--color-negro); transform: translateY(-3px); box-shadow: 0 15px 25px rgba(255, 68, 68, 0.4); }
        ...
        .mechanic-icon { width: 60px; height: 60px; background: rgba(255,68,68,0.1); color: var(--color-principal); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 24px; }
        ...
        /* THE RULES BOX */
        .rules-box { border: 2px solid var(--color-principal); border-radius: 12px; padding: 40px; background: rgba(255,68,68,0.02); display: flex; gap: 40px; align-items: center; }
    ...
    <div class="movie-hero">
        ...
        <div class="movie-content">
            ...
            <div class="movie-info">
                <span class="movie-id">SURVIVAL EVENT</span>
                <h1 class="movie-title">Horror Marathon</h1>

                <div class="movie-meta">
                    <span class="age-badge">+18</span>
                    <span>Horror / Slasher</span>
                    <span>Approx. 6h 00m</span>
                    <span style="color: var(--color-principal); font-weight: bold;">November 12 • 23:00</span>
                </div>

                <p class="movie-desc">Tres películas seguidas hasta el amanecer. Solo para los más valientes. Disfruta de una selección de terror moderno y clásicos de culto sin interrupciones. Incluye kit de supervivencia.</p>
                ...
                <div class="action-buttons">
                    ...
                    @auth
                        @php
                            // Lógica de fecha: El evento se abre el 12 de Nov de 2026
        ...
        <div class="container">
            ...
            <div class="mechanics-grid">
                <div class="mechanic-card">
                    ...
                    <h3>1. The Setup</h3>
                    <p>3 películas seguidas con descansos de 15 minutos exactos para recuperar el aliento.</p>
                </div>
                <div class="mechanic-card">
                    <div class="mechanic-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>
                    </div>
                    <h3>2. Survival Kit</h3>
                    <p>Recoge tu kit de supervivencia al entrar: incluye café ilimitado durante toda la noche.</p>
                </div>
                <div class="mechanic-card">
                    <div class="mechanic-icon">
                    ...
                    <h3>3. The Survivors</h3>
                    <p>Si aguantas en tu asiento hasta los créditos finales, recibirás un certificado y póster exclusivo.</p>
                </div>
            </div>

            <div class="clues-wrapper">
                <div class="clues-header">
                    <h3>Survival Details</h3>
                    <p style="color: #aaa; font-family: Arial, sans-serif;">What to expect during the longest night at Screenbites:</p>
                </div>
                <div class="clues-list">
                    <div class="clue-item">"The first film is a 70s slasher classic that defined the 'final girl' trope."</div>
                    <div class="clue-item">"The marathon includes a modern supernatural masterpiece from the A24 studio."</div>
                    <div class="clue-item">"Expect surprises in the theater between movies - the horror doesn't stop."</div>
                    <div class="clue-item">"One single seat for the entire night. Choose wisely, you'll be there a long time."</div>
                </div>
            </div>
            ...
            <div class="rules-box">
                ...
                <div class="rules-content">
                    <h3>The Rules of the Marathon</h3>
                    <ul>
                        <li><strong>Strictly +18:</strong> Content contains graphic violence and psychological horror.</li>
                        <li><strong>No Exit:</strong> Leaving the theater building during the marathon disqualifies you from the reward.</li>
                        <li><strong>Zero Phones:</strong> To preserve the atmosphere, phones must be completely turned off.</li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        function addEventTicketToCart() {
            ...
            let eventOrder = {
                id: 'ORD-HRR-' + Date.now(),
                movieId: 'horror-01',
                movieTitle: 'Horror Marathon',
                color: '#ff4444',
                textColor: 'white',
                tickets: { seats: 'Survival Seat', price: 12.00 },
                food: [],
                orderTotal: 12.00
            };
